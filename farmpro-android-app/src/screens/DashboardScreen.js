      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.hero}>
          ...
          <Text style={styles.heroCopy}>
            Use this Android client to manage FARMERPRO marketplace, payments, social integrations,
        ...
        <View style={styles.checklist}>
          ...
          <Text style={styles.checkItem}>- API integration to FARMERPRO services</Text>
